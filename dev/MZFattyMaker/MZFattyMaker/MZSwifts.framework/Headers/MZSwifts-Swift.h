...
SWIFT_MODULE_NAMESPACE_PUSH("MZSwifts")
...
@interface MZMediaLibraryPicker : NSObject <UINavigationControllerDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class UIImagePickerController;

@interface MZMediaLibraryPicker (SWIFT_EXTENSION(MZSwifts)) <UIImagePickerControllerDelegate>
